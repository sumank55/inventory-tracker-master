    ...
    "PERMISSIONS": ObjDict(
        {
            ...
            "set_username": ["authentication.permissions.CurrentUserOrAdmin"],
            "user_create": ["rest_framework.permissions.AllowAny"],
            "user_delete": ["authentication.permissions.CurrentUserOrAdmin"],
            "user": ["authentication.permissions.CurrentUserOrAdmin"],
            "user_list": ["authentication.permissions.CurrentUserOrAdmin"],
